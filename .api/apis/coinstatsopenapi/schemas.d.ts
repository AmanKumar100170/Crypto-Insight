        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly from: {
                    ...
                    readonly type: "string";
                    readonly examples: readonly ["2024-08-30T10:24:03.983Z"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                ...
                readonly to: {
                    readonly format: "date-time";
                    readonly type: "string";
                    readonly examples: readonly ["2024-08-31T12:24:03.983Z"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Please include the date in ISO 8601 format";
                };
                readonly currency: {
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly from: {
                    readonly format: "date-time";
                    readonly type: "string";
                    readonly examples: readonly ["2024-08-30T10:24:03.987Z"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Please include the date in ISO 8601 format";
                };
                readonly to: {
                    readonly format: "date-time";
                    readonly type: "string";
                    readonly examples: readonly ["2024-08-31T12:24:03.987Z"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Please include the date in ISO 8601 format";
                };
            };
